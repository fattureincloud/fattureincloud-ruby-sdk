...
# Unit tests for module_name::CompanyInfoPlanInfoFunctions
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe module_name::CompanyInfoPlanInfoFunctions do
  let(:instance) { module_name::CompanyInfoPlanInfoFunctions.new }
  ...
  describe 'test an instance of CompanyInfoPlanInfoFunctions' do
    it 'should create an instance of CompanyInfoPlanInfoFunctions' do
      expect(instance).to be_instance_of(module_name::CompanyInfoPlanInfoFunctions)
    end
  end
