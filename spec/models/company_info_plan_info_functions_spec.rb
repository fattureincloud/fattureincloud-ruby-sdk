...
# Unit tests for FattureInCloudSdk::CompanyInfoPlanInfoFunctions
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FattureInCloudSdk::CompanyInfoPlanInfoFunctions do
  let(:instance) { FattureInCloudSdk::CompanyInfoPlanInfoFunctions.new }
  ...
  describe 'test an instance of CompanyInfoPlanInfoFunctions' do
    it 'should create an instance of CompanyInfoPlanInfoFunctions' do
      expect(instance).to be_instance_of(FattureInCloudSdk::CompanyInfoPlanInfoFunctions)
    end
  end
