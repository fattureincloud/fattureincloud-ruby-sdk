...
# Unit tests for FattureInCloudSdk::EmailData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FattureInCloudSdk::EmailData do
  let(:instance) { FattureInCloudSdk::EmailData.new }

  describe 'test an instance of EmailData' do
    it 'should create an instance of EmailData' do
      expect(instance).to be_instance_of(FattureInCloudSdk::EmailData)
    end
  end
