...
# Unit tests for FattureInCloud::Ruby::Sdk::EmailData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FattureInCloud::Ruby::Sdk::EmailData do
  let(:instance) { FattureInCloud::Ruby::Sdk::EmailData.new }

  describe 'test an instance of EmailData' do
    it 'should create an instance of EmailData' do
      expect(instance).to be_instance_of(FattureInCloud::Ruby::Sdk::EmailData)
    end
  end
