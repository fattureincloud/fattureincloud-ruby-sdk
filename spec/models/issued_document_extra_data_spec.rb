...
# Unit tests for FattureInCloud::Ruby::Sdk::IssuedDocumentExtraData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FattureInCloud::Ruby::Sdk::IssuedDocumentExtraData do
  let(:instance) { FattureInCloud::Ruby::Sdk::IssuedDocumentExtraData.new }

  describe 'test an instance of IssuedDocumentExtraData' do
    it 'should create an instance of IssuedDocumentExtraData' do
      expect(instance).to be_instance_of(FattureInCloud::Ruby::Sdk::IssuedDocumentExtraData)
    end
  end
