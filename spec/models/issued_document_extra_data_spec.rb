...
# Unit tests for module_name::IssuedDocumentExtraData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe module_name::IssuedDocumentExtraData do
  let(:instance) { module_name::IssuedDocumentExtraData.new }

  describe 'test an instance of IssuedDocumentExtraData' do
    it 'should create an instance of IssuedDocumentExtraData' do
      expect(instance).to be_instance_of(module_name::IssuedDocumentExtraData)
    end
  end
