...
# Unit tests for FattureInCloudSdk::IssuedDocumentExtraData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FattureInCloudSdk::IssuedDocumentExtraData do
  let(:instance) { FattureInCloudSdk::IssuedDocumentExtraData.new }

  describe 'test an instance of IssuedDocumentExtraData' do
    it 'should create an instance of IssuedDocumentExtraData' do
      expect(instance).to be_instance_of(FattureInCloudSdk::IssuedDocumentExtraData)
    end
  end
