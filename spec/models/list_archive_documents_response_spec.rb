...
# Unit tests for FattureInCloudSdk::ListArchiveDocumentsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FattureInCloudSdk::ListArchiveDocumentsResponse do
  let(:instance) { FattureInCloudSdk::ListArchiveDocumentsResponse.new }
  ...
  describe 'test an instance of ListArchiveDocumentsResponse' do
    it 'should create an instance of ListArchiveDocumentsResponse' do
      expect(instance).to be_instance_of(FattureInCloudSdk::ListArchiveDocumentsResponse)
    end
  end
