...
# Unit tests for module_name::ListArchiveDocumentsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe module_name::ListArchiveDocumentsResponse do
  let(:instance) { module_name::ListArchiveDocumentsResponse.new }
  ...
  describe 'test an instance of ListArchiveDocumentsResponse' do
    it 'should create an instance of ListArchiveDocumentsResponse' do
      expect(instance).to be_instance_of(module_name::ListArchiveDocumentsResponse)
    end
  end
