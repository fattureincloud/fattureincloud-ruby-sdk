...
# Unit tests for FattureInCloud::Ruby::Sdk::ListArchiveDocumentsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FattureInCloud::Ruby::Sdk::ListArchiveDocumentsResponse do
  let(:instance) { FattureInCloud::Ruby::Sdk::ListArchiveDocumentsResponse.new }
  ...
  describe 'test an instance of ListArchiveDocumentsResponse' do
    it 'should create an instance of ListArchiveDocumentsResponse' do
      expect(instance).to be_instance_of(FattureInCloud::Ruby::Sdk::ListArchiveDocumentsResponse)
    end
  end
