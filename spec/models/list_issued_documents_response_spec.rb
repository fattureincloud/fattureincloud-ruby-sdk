...
# Unit tests for FattureInCloudSdk::ListIssuedDocumentsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FattureInCloudSdk::ListIssuedDocumentsResponse do
  let(:instance) { FattureInCloudSdk::ListIssuedDocumentsResponse.new }
  ...
  describe 'test an instance of ListIssuedDocumentsResponse' do
    it 'should create an instance of ListIssuedDocumentsResponse' do
      expect(instance).to be_instance_of(FattureInCloudSdk::ListIssuedDocumentsResponse)
    end
  end
