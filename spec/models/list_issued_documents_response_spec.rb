...
# Unit tests for module_name::ListIssuedDocumentsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe module_name::ListIssuedDocumentsResponse do
  let(:instance) { module_name::ListIssuedDocumentsResponse.new }
  ...
  describe 'test an instance of ListIssuedDocumentsResponse' do
    it 'should create an instance of ListIssuedDocumentsResponse' do
      expect(instance).to be_instance_of(module_name::ListIssuedDocumentsResponse)
    end
  end
