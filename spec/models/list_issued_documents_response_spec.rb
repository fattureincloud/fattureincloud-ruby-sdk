...
# Unit tests for FattureInCloud::Ruby::Sdk::ListIssuedDocumentsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FattureInCloud::Ruby::Sdk::ListIssuedDocumentsResponse do
  let(:instance) { FattureInCloud::Ruby::Sdk::ListIssuedDocumentsResponse.new }
  ...
  describe 'test an instance of ListIssuedDocumentsResponse' do
    it 'should create an instance of ListIssuedDocumentsResponse' do
      expect(instance).to be_instance_of(FattureInCloud::Ruby::Sdk::ListIssuedDocumentsResponse)
    end
  end
