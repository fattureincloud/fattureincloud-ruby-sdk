...
# Unit tests for module_name::ReceiptItemsListItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe module_name::ReceiptItemsListItem do
  let(:instance) { module_name::ReceiptItemsListItem.new }

  describe 'test an instance of ReceiptItemsListItem' do
    it 'should create an instance of ReceiptItemsListItem' do
      expect(instance).to be_instance_of(module_name::ReceiptItemsListItem)
    end
  end
