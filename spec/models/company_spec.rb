...
# Unit tests for FattureInCloud::Ruby::Sdk::Company
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FattureInCloud::Ruby::Sdk::Company do
  let(:instance) { FattureInCloud::Ruby::Sdk::Company.new }

  describe 'test an instance of Company' do
    it 'should create an instance of Company' do
      expect(instance).to be_instance_of(FattureInCloud::Ruby::Sdk::Company)
    end
  end
