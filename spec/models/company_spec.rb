...
# Unit tests for module_name::Company
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe module_name::Company do
  let(:instance) { module_name::Company.new }

  describe 'test an instance of Company' do
    it 'should create an instance of Company' do
      expect(instance).to be_instance_of(module_name::Company)
    end
  end
