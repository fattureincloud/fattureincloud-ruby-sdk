...
# Unit tests for FattureInCloudSdk::Company
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FattureInCloudSdk::Company do
  let(:instance) { FattureInCloudSdk::Company.new }

  describe 'test an instance of Company' do
    it 'should create an instance of Company' do
      expect(instance).to be_instance_of(FattureInCloudSdk::Company)
    end
  end
