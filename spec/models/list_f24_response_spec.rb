...
# Unit tests for FattureInCloudSdk::ListF24Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FattureInCloudSdk::ListF24Response do
  let(:instance) { FattureInCloudSdk::ListF24Response.new }

  describe 'test an instance of ListF24Response' do
    it 'should create an instance of ListF24Response' do
      expect(instance).to be_instance_of(FattureInCloudSdk::ListF24Response)
    end
  end
