...
# Unit tests for module_name::ListF24Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe module_name::ListF24Response do
  let(:instance) { module_name::ListF24Response.new }

  describe 'test an instance of ListF24Response' do
    it 'should create an instance of ListF24Response' do
      expect(instance).to be_instance_of(module_name::ListF24Response)
    end
  end
