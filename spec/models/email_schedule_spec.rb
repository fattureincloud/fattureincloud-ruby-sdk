...
# Unit tests for FattureInCloud::Ruby::Sdk::EmailSchedule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FattureInCloud::Ruby::Sdk::EmailSchedule do
  let(:instance) { FattureInCloud::Ruby::Sdk::EmailSchedule.new }

  describe 'test an instance of EmailSchedule' do
    it 'should create an instance of EmailSchedule' do
      expect(instance).to be_instance_of(FattureInCloud::Ruby::Sdk::EmailSchedule)
    end
  end
