...
# Unit tests for module_name::EmailSchedule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe module_name::EmailSchedule do
  let(:instance) { module_name::EmailSchedule.new }

  describe 'test an instance of EmailSchedule' do
    it 'should create an instance of EmailSchedule' do
      expect(instance).to be_instance_of(module_name::EmailSchedule)
    end
  end
