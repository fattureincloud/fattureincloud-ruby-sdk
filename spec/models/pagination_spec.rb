...
# Unit tests for FattureInCloudSdk::Pagination
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FattureInCloudSdk::Pagination do
  let(:instance) { FattureInCloudSdk::Pagination.new }

  describe 'test an instance of Pagination' do
    it 'should create an instance of Pagination' do
      expect(instance).to be_instance_of(FattureInCloudSdk::Pagination)
    end
  end
