...
# Unit tests for FattureInCloud::Ruby::Sdk::VatType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FattureInCloud::Ruby::Sdk::VatType do
  let(:instance) { FattureInCloud::Ruby::Sdk::VatType.new }

  describe 'test an instance of VatType' do
    it 'should create an instance of VatType' do
      expect(instance).to be_instance_of(FattureInCloud::Ruby::Sdk::VatType)
    end
  end
