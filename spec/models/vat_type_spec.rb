...
# Unit tests for FattureInCloudSdk::VatType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FattureInCloudSdk::VatType do
  let(:instance) { FattureInCloudSdk::VatType.new }

  describe 'test an instance of VatType' do
    it 'should create an instance of VatType' do
      expect(instance).to be_instance_of(FattureInCloudSdk::VatType)
    end
  end
