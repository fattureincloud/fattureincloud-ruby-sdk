...
# Unit tests for module_name::VatType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe module_name::VatType do
  let(:instance) { module_name::VatType.new }

  describe 'test an instance of VatType' do
    it 'should create an instance of VatType' do
      expect(instance).to be_instance_of(module_name::VatType)
    end
  end
