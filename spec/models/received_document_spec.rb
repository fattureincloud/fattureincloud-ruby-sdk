...
# Unit tests for module_name::ReceivedDocument
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe module_name::ReceivedDocument do
  let(:instance) { module_name::ReceivedDocument.new }

  describe 'test an instance of ReceivedDocument' do
    it 'should create an instance of ReceivedDocument' do
      expect(instance).to be_instance_of(module_name::ReceivedDocument)
    end
  end
