...
# Unit tests for FattureInCloud::Ruby::Sdk::ReceivedDocument
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FattureInCloud::Ruby::Sdk::ReceivedDocument do
  let(:instance) { FattureInCloud::Ruby::Sdk::ReceivedDocument.new }

  describe 'test an instance of ReceivedDocument' do
    it 'should create an instance of ReceivedDocument' do
      expect(instance).to be_instance_of(FattureInCloud::Ruby::Sdk::ReceivedDocument)
    end
  end
