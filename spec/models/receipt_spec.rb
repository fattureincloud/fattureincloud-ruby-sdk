...
# Unit tests for FattureInCloud::Ruby::Sdk::Receipt
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FattureInCloud::Ruby::Sdk::Receipt do
  let(:instance) { FattureInCloud::Ruby::Sdk::Receipt.new }

  describe 'test an instance of Receipt' do
    it 'should create an instance of Receipt' do
      expect(instance).to be_instance_of(FattureInCloud::Ruby::Sdk::Receipt)
    end
  end
