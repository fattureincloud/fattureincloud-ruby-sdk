...
# Unit tests for FattureInCloudSdk::Receipt
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FattureInCloudSdk::Receipt do
  let(:instance) { FattureInCloudSdk::Receipt.new }

  describe 'test an instance of Receipt' do
    it 'should create an instance of Receipt' do
      expect(instance).to be_instance_of(FattureInCloudSdk::Receipt)
    end
  end
