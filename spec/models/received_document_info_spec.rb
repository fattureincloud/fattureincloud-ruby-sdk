...
# Unit tests for FattureInCloudSdk::ReceivedDocumentInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FattureInCloudSdk::ReceivedDocumentInfo do
  let(:instance) { FattureInCloudSdk::ReceivedDocumentInfo.new }

  describe 'test an instance of ReceivedDocumentInfo' do
    it 'should create an instance of ReceivedDocumentInfo' do
      expect(instance).to be_instance_of(FattureInCloudSdk::ReceivedDocumentInfo)
    end
  end
