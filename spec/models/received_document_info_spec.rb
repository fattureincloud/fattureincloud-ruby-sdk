...
# Unit tests for FattureInCloud::Ruby::Sdk::ReceivedDocumentInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FattureInCloud::Ruby::Sdk::ReceivedDocumentInfo do
  let(:instance) { FattureInCloud::Ruby::Sdk::ReceivedDocumentInfo.new }

  describe 'test an instance of ReceivedDocumentInfo' do
    it 'should create an instance of ReceivedDocumentInfo' do
      expect(instance).to be_instance_of(FattureInCloud::Ruby::Sdk::ReceivedDocumentInfo)
    end
  end
