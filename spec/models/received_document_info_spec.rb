...
# Unit tests for module_name::ReceivedDocumentInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe module_name::ReceivedDocumentInfo do
  let(:instance) { module_name::ReceivedDocumentInfo.new }

  describe 'test an instance of ReceivedDocumentInfo' do
    it 'should create an instance of ReceivedDocumentInfo' do
      expect(instance).to be_instance_of(module_name::ReceivedDocumentInfo)
    end
  end
