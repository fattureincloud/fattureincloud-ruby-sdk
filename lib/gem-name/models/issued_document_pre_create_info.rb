...
module module_name
  class IssuedDocumentPreCreateInfo
    ...
    attr_accessor :dn_numerations

    attr_accessor :default_values

    attr_accessor :extra_data_default_values

    attr_accessor :items_default_values

    # Countries list.
    attr_accessor :countries_list
    ...
    attr_accessor :dn_templates_list

    # Accompanying invoice templates list.
    attr_accessor :ai_templates_list

    # Payment methods list.
    attr_accessor :payment_methods_list
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `module_name::IssuedDocumentPreCreateInfo` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `module_name::IssuedDocumentPreCreateInfo`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'dn_numerations')
        self.dn_numerations = attributes[:'dn_numerations']
      end
    ...
    def hash
      [numerations, dn_numerations, default_values, extra_data_default_values, items_default_values, countries_list, currencies_list, templates_list, dn_templates_list, ai_templates_list, payment_methods_list, payment_accounts_list, vat_types_list].hash
    end
