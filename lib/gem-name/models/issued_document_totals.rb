  ...
  class IssuedDocumentTotals
    ...
    def self.openapi_types
      {
        ...
        :'payments_sum' => :'Float',
        :'vat_list' => :'IssuedDocumentTotalsVatList'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `module_name::IssuedDocumentTotals` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `module_name::IssuedDocumentTotals`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'vat_list')
        self.vat_list = attributes[:'vat_list']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @is_enasarco_maximal_exceeded.nil?
        invalid_properties.push('invalid value for "is_enasarco_maximal_exceeded", is_enasarco_maximal_exceeded cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @is_enasarco_maximal_exceeded.nil?
