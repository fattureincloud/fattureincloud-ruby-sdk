...
module FattureInCloud_Ruby_Sdk
  class ReceivedDocumentType
    ...
    def build_from_hash(value)
      constantValues = ReceivedDocumentType.constants.select { |c| ReceivedDocumentType::const_get(c) == value }
      raise "Invalid ENUM value #{value} for class #ReceivedDocumentType" if constantValues.empty?
      value
    end
  end
end
