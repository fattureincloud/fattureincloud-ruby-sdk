...
module FattureInCloud_Ruby_Sdk
  ...
  class CompanyInfoPlanInfoFunctions < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FattureInCloud_Ruby_Sdk::CompanyInfoPlanInfoFunctions`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [archive, cerved, document_attachments, e_invoice, genius, mail_tracking, payment_notifications, paypal, receipts, recurring, smtp, stock, subaccounts, tessera_sanitaria, ts_digital, ts_invoice_trading, ts_pay].hash
    end
