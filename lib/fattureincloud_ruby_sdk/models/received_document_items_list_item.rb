...
module FattureInCloud_Ruby_Sdk
  class ReceivedDocumentItemsListItem < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `FattureInCloud_Ruby_Sdk::ReceivedDocumentItemsListItem` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FattureInCloud_Ruby_Sdk::ReceivedDocumentItemsListItem`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'deductibility_vat_percentage')
        self.deductibility_vat_percentage = attributes[:'deductibility_vat_percentage']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          vat == o.vat &&
          stock == o.stock &&
          deductibility_vat_percentage == o.deductibility_vat_percentage
    end
    ...
    def hash
      [id, product_id, code, name, measure, net_price, category, qty, vat, stock, deductibility_vat_percentage].hash
    end
