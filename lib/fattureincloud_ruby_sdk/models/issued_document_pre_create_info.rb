...
module FattureInCloud_Ruby_Sdk
  class IssuedDocumentPreCreateInfo < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FattureInCloud_Ruby_Sdk::IssuedDocumentPreCreateInfo`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [numerations, dn_numerations, default_values, extra_data_default_values, items_default_values, countries_list, currencies_list, templates_list, dn_templates_list, ai_templates_list, payment_methods_list, payment_accounts_list, vat_types_list, languages_list, price_lists].hash
    end
