...
module FattureInCloud_Ruby_Sdk
  class CashbookEntry < ApiModelBase
    # Cashbook id
    attr_accessor :id
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FattureInCloud_Ruby_Sdk::CashbookEntry`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [id, date, description, kind, type, entity_name, document, amount_in, payment_account_in, amount_out, payment_account_out].hash
    end
