...
module FattureInCloud_Ruby_Sdk
  ...
  class IssuedDocument
    ...
    def list_invalid_properties
      ...
      if !@cassa_taxable.nil? && @cassa_taxable > 100
        invalid_properties.push('invalid value for "cassa_taxable", must be smaller than or equal to 100.')
      end

      if !@cassa_taxable.nil? && @cassa_taxable < 0
        invalid_properties.push('invalid value for "cassa_taxable", must be greater than or equal to 0.')
      end

      if !@cassa2.nil? && @cassa2 > 100
        invalid_properties.push('invalid value for "cassa2", must be smaller than or equal to 100.')
      end

      if !@cassa2.nil? && @cassa2 < 0
        invalid_properties.push('invalid value for "cassa2", must be greater than or equal to 0.')
      end

      if !@cassa2_taxable.nil? && @cassa2_taxable > 100
        invalid_properties.push('invalid value for "cassa2_taxable", must be smaller than or equal to 100.')
      end

      if !@cassa2_taxable.nil? && @cassa2_taxable < 0
        invalid_properties.push('invalid value for "cassa2_taxable", must be greater than or equal to 0.')
      end

      if !@global_cassa_taxable.nil? && @global_cassa_taxable > 100
        invalid_properties.push('invalid value for "global_cassa_taxable", must be smaller than or equal to 100.')
      end

      if !@global_cassa_taxable.nil? && @global_cassa_taxable < 0
        invalid_properties.push('invalid value for "global_cassa_taxable", must be greater than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if !@cassa_taxable.nil? && @cassa_taxable > 100
      return false if !@cassa_taxable.nil? && @cassa_taxable < 0
      return false if !@cassa2.nil? && @cassa2 > 100
      return false if !@cassa2.nil? && @cassa2 < 0
      return false if !@cassa2_taxable.nil? && @cassa2_taxable > 100
      return false if !@cassa2_taxable.nil? && @cassa2_taxable < 0
      return false if !@global_cassa_taxable.nil? && @global_cassa_taxable > 100
      return false if !@global_cassa_taxable.nil? && @global_cassa_taxable < 0
    ...
    # Custom attribute writer method with validation
    # @param [Object] cassa_taxable Value to be assigned
    def cassa_taxable=(cassa_taxable)
      if !cassa_taxable.nil? && cassa_taxable > 100
        fail ArgumentError, 'invalid value for "cassa_taxable", must be smaller than or equal to 100.'
      end

      if !cassa_taxable.nil? && cassa_taxable < 0
        fail ArgumentError, 'invalid value for "cassa_taxable", must be greater than or equal to 0.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] cassa2 Value to be assigned
    def cassa2=(cassa2)
      if !cassa2.nil? && cassa2 > 100
        fail ArgumentError, 'invalid value for "cassa2", must be smaller than or equal to 100.'
      end

      if !cassa2.nil? && cassa2 < 0
        fail ArgumentError, 'invalid value for "cassa2", must be greater than or equal to 0.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] cassa2_taxable Value to be assigned
    def cassa2_taxable=(cassa2_taxable)
      if !cassa2_taxable.nil? && cassa2_taxable > 100
        fail ArgumentError, 'invalid value for "cassa2_taxable", must be smaller than or equal to 100.'
      end

      if !cassa2_taxable.nil? && cassa2_taxable < 0
        fail ArgumentError, 'invalid value for "cassa2_taxable", must be greater than or equal to 0.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] global_cassa_taxable Value to be assigned
    def global_cassa_taxable=(global_cassa_taxable)
      if !global_cassa_taxable.nil? && global_cassa_taxable > 100
        fail ArgumentError, 'invalid value for "global_cassa_taxable", must be smaller than or equal to 100.'
      end

      if !global_cassa_taxable.nil? && global_cassa_taxable < 0
        fail ArgumentError, 'invalid value for "global_cassa_taxable", must be greater than or equal to 0.'
      end
