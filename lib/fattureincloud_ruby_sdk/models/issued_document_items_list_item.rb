...
module FattureInCloud_Ruby_Sdk
  class IssuedDocumentItemsListItem < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FattureInCloud_Ruby_Sdk::IssuedDocumentItemsListItem`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'in_dn')
        self.in_dn = attributes[:'in_dn']
      end
    ...
    def hash
      [id, product_id, code, name, category, description, qty, measure, net_price, gross_price, vat, not_taxable, apply_withholding_taxes, discount, discount_highlight, in_dn, stock, ei_raw].hash
    end
