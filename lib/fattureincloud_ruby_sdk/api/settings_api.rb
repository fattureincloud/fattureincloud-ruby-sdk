...
module FattureInCloud_Ruby_Sdk
  class SettingsApi
    ...
    # @param company_id [Integer] The ID of the company.
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetTaxProfileResponse, Integer, Hash)>] GetTaxProfileResponse data, response status code and response headers
    ...
    # @param company_id [Integer] The ID of the company.
    # @param template_id [Integer] The Referred Template Id.
    # @param [Hash] opts the optional parameters
    # @option opts [String] :fields List of comma-separated fields.
    # @option opts [String] :fieldset Name of the fieldset.
    # @return [GetTemplatesResponse]
    def get_template(company_id, template_id, opts = {})
      data, _status_code, _headers = get_template_with_http_info(company_id, template_id, opts)
      data
    end
    ...
    def get_template_with_http_info(company_id, template_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SettingsApi.get_template ...'
      end
      # verify the required parameter 'company_id' is set
      if @api_client.config.client_side_validation && company_id.nil?
        fail ArgumentError, "Missing the required parameter 'company_id' when calling SettingsApi.get_template"
      end
      # verify the required parameter 'template_id' is set
      if @api_client.config.client_side_validation && template_id.nil?
        fail ArgumentError, "Missing the required parameter 'template_id' when calling SettingsApi.get_template"
      end
      allowable_values = ["basic", "detailed"]
      if @api_client.config.client_side_validation && opts[:'fieldset'] && !allowable_values.include?(opts[:'fieldset'])
        fail ArgumentError, "invalid value for \"fieldset\", must be one of #{allowable_values}"
      ...
      # resource path
      local_var_path = '/c/{company_id}/settings/templates/{template_id}'.sub('{' + 'company_id' + '}', CGI.escape(company_id.to_s)).sub('{' + 'template_id' + '}', CGI.escape(template_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"SettingsApi.get_template",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SettingsApi#get_template\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_templates_with_http_info(company_id, opts = {})
      ...
      # resource path
      local_var_path = '/c/{company_id}/settings/templates'.sub('{' + 'company_id' + '}', CGI.escape(company_id.to_s))
