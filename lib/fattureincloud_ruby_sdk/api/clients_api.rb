...
module FattureInCloud_Ruby_Sdk
  class ClientsApi
    ...
    def get_client_info(company_id, opts = {})
      data, _status_code, _headers = get_client_info_with_http_info(company_id, opts)
      data
    end
    ...
    # @param company_id [Integer] The ID of the company.
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetEntityClientPreCreateInfoResponse, Integer, Hash)>] GetEntityClientPreCreateInfoResponse data, response status code and response headers
    def get_client_info_with_http_info(company_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ClientsApi.get_client_info ...'
      end
      # verify the required parameter 'company_id' is set
      if @api_client.config.client_side_validation && company_id.nil?
        fail ArgumentError, "Missing the required parameter 'company_id' when calling ClientsApi.get_client_info"
      end
      # resource path
      local_var_path = '/c/{company_id}/entities/clients/info'.sub('{' + 'company_id' + '}', CGI.escape(company_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetEntityClientPreCreateInfoResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2AuthenticationCodeFlow']

      new_options = opts.merge(
        :operation => :"ClientsApi.get_client_info",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ClientsApi#get_client_info\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
