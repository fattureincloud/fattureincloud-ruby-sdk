  ...
  class ArchiveApi
    ...
    def list_archive_documents_with_http_info(company_id, opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling ArchiveApi.list_archive_documents, must be smaller than or equal to 100.'
      end

      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] < 1
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling ArchiveApi.list_archive_documents, must be greater than or equal to 1.'
      end
