...
module FattureInCloud_Ruby_Sdk
  class ReceivedDocumentsApi
    ...
    # @param document_id [Integer] The ID of the document.
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetBinReceivedDocumentResponse, Integer, Hash)>] GetBinReceivedDocumentResponse data, response status code and response headers
    ...
    # @option opts [String] :fields List of comma-separated fields.
    # @option opts [String] :fieldset Name of the fieldset.
    # @return [Array<(GetPendingReceivedDocumentResponse, Integer, Hash)>] GetPendingReceivedDocumentResponse data, response status code and response headers
    ...
    # @param company_id [Integer] The ID of the company.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ListBinReceivedDocuments, Integer, Hash)>] ListBinReceivedDocuments data, response status code and response headers
    ...
    # @param company_id [Integer] The ID of the company.
    # @param type [String] The type of the pending received document.
    # @param [Hash] opts the optional parameters
    # @option opts [String] :fields List of comma-separated fields.
    # @option opts [String] :fieldset Name of the fieldset.
    ...
    # @option opts [Integer] :per_page The size of the page. (default to 5)
    # @option opts [String] :q Query for filtering the results.
    # @return [Array<(ListPendingReceivedDocumentsResponse, Integer, Hash)>] ListPendingReceivedDocumentsResponse data, response status code and response headers
