...
module FattureInCloud_Ruby_Sdk
  class WebhooksApi
    ...
    # @param subscription_id [String] The ID of the subscription.
    # @param [Hash] opts the optional parameters
    # @option opts [VerifyWebhooksSubscriptionRequest] :verify_webhooks_subscription_request 
    # @return [nil]
    def verify_webhooks_subscription(company_id, subscription_id, opts = {})
      verify_webhooks_subscription_with_http_info(company_id, subscription_id, opts)
      nil
    end
    ...
    # @option opts [VerifyWebhooksSubscriptionRequest] :verify_webhooks_subscription_request 
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def verify_webhooks_subscription_with_http_info(company_id, subscription_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WebhooksApi.verify_webhooks_subscription ...'
      end
      # verify the required parameter 'company_id' is set
      if @api_client.config.client_side_validation && company_id.nil?
        fail ArgumentError, "Missing the required parameter 'company_id' when calling WebhooksApi.verify_webhooks_subscription"
      end
      # verify the required parameter 'subscription_id' is set
      if @api_client.config.client_side_validation && subscription_id.nil?
        fail ArgumentError, "Missing the required parameter 'subscription_id' when calling WebhooksApi.verify_webhooks_subscription"
      end
      # resource path
      local_var_path = '/c/{company_id}/subscriptions/{subscription_id}/verify'.sub('{' + 'company_id' + '}', CGI.escape(company_id.to_s)).sub('{' + 'subscription_id' + '}', CGI.escape(subscription_id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'verify_webhooks_subscription_request'])
      ...
      new_options = opts.merge(
        :operation => :"WebhooksApi.verify_webhooks_subscription",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WebhooksApi#verify_webhooks_subscription\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
