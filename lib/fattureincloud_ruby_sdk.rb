...
require 'fattureincloud_ruby_sdk/models/attachment'
...
require 'fattureincloud_ruby_sdk/models/entity_client_pre_create_info'
...
require 'fattureincloud_ruby_sdk/models/get_bin_issued_document_response'
require 'fattureincloud_ruby_sdk/models/get_bin_received_document_response'
...
require 'fattureincloud_ruby_sdk/models/get_entity_client_pre_create_info_response'
...
require 'fattureincloud_ruby_sdk/models/get_pending_received_document_response'
...
require 'fattureincloud_ruby_sdk/models/list_bin_issued_documents'
require 'fattureincloud_ruby_sdk/models/list_bin_received_documents'
...
require 'fattureincloud_ruby_sdk/models/list_pending_received_documents_response'
require 'fattureincloud_ruby_sdk/models/list_pending_received_documents_response_page'
require 'fattureincloud_ruby_sdk/models/list_price_lists_response'
...
require 'fattureincloud_ruby_sdk/models/pending_received_document'
require 'fattureincloud_ruby_sdk/models/pending_received_document_extracted_data'
require 'fattureincloud_ruby_sdk/models/pending_received_document_extracted_data_mining'
require 'fattureincloud_ruby_sdk/models/pending_received_document_payments_list_item'
require 'fattureincloud_ruby_sdk/models/pending_received_document_payments_list_item_payment_terms'
require 'fattureincloud_ruby_sdk/models/pending_received_document_type'
...
require 'fattureincloud_ruby_sdk/models/price_list'
require 'fattureincloud_ruby_sdk/models/price_list_item'
require 'fattureincloud_ruby_sdk/models/price_list_prices_type'
require 'fattureincloud_ruby_sdk/models/price_list_type'
...
require 'fattureincloud_ruby_sdk/models/template_type'
...
require 'fattureincloud_ruby_sdk/models/verify_webhooks_subscription'
require 'fattureincloud_ruby_sdk/models/verify_webhooks_subscription_request'
...
require 'fattureincloud_ruby_sdk/models/webhooks_subscription_verification_method'
...
require 'fattureincloud_ruby_sdk/api/price_lists_api'
