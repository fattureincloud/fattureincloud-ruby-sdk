...
require 'fattureincloud_ruby_sdk/models/cashbook_entry_data'
require 'fattureincloud_ruby_sdk/models/cashbook_entry_data_document'
require 'fattureincloud_ruby_sdk/models/cashbook_entry_in'
require 'fattureincloud_ruby_sdk/models/cashbook_entry_in_data'
require 'fattureincloud_ruby_sdk/models/cashbook_entry_in_out'
require 'fattureincloud_ruby_sdk/models/cashbook_entry_kind'
require 'fattureincloud_ruby_sdk/models/cashbook_entry_out'
require 'fattureincloud_ruby_sdk/models/cashbook_entry_out_data'
...
require 'fattureincloud_ruby_sdk/models/email_data_sender_emails_list'
...
require 'fattureincloud_ruby_sdk/models/issued_document_items_list'
require 'fattureincloud_ruby_sdk/models/issued_document_payments_list'
...
require 'fattureincloud_ruby_sdk/models/issued_document_refers_to'
...
require 'fattureincloud_ruby_sdk/models/issued_document_totals_vat_list'
require 'fattureincloud_ruby_sdk/models/issued_document_totals_vat_list_vat_item'
...
require 'fattureincloud_ruby_sdk/models/list_f24_response_aggregated_data_aggregated_data'
...
require 'fattureincloud_ruby_sdk/models/received_document_items_list'
require 'fattureincloud_ruby_sdk/models/received_document_payment_terms'
require 'fattureincloud_ruby_sdk/models/received_document_payments_list'
...
require 'fattureincloud_ruby_sdk/models/upload_issued_document_attachment_response_data'
require 'fattureincloud_ruby_sdk/models/upload_received_document_attachment_response'
require 'fattureincloud_ruby_sdk/models/upload_received_document_attachment_response_data'
