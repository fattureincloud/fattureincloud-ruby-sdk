...
```shell
gem install ./fattureincloud_ruby_sdk-2.0.1.gem
```

(for development, run `gem install --dev ./fattureincloud_ruby_sdk-2.0.1.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'fattureincloud_ruby_sdk', '~> 2.0.1'
...
If the Ruby gem is hosted at a git repository: https://github.com/fattureincloud/fattureincloud-ruby-sdk, then add the following in the Gemfile:
    ...
    gem 'fattureincloud_ruby_sdk', :git => 'https://github.com/fattureincloud/fattureincloud-ruby-sdk.git'
...
## Documentation for Models
 ...
 - [FattureInCloud_Ruby_Sdk::CashbookEntryData](docs/CashbookEntryData.md)
 - [FattureInCloud_Ruby_Sdk::CashbookEntryDataDocument](docs/CashbookEntryDataDocument.md)
 - [FattureInCloud_Ruby_Sdk::CashbookEntryIn](docs/CashbookEntryIn.md)
 - [FattureInCloud_Ruby_Sdk::CashbookEntryInData](docs/CashbookEntryInData.md)
 - [FattureInCloud_Ruby_Sdk::CashbookEntryInOut](docs/CashbookEntryInOut.md)
 - [FattureInCloud_Ruby_Sdk::CashbookEntryKind](docs/CashbookEntryKind.md)
 - [FattureInCloud_Ruby_Sdk::CashbookEntryOut](docs/CashbookEntryOut.md)
 - [FattureInCloud_Ruby_Sdk::CashbookEntryOutData](docs/CashbookEntryOutData.md)
 ...
 - [FattureInCloud_Ruby_Sdk::EmailDataSenderEmailsList](docs/EmailDataSenderEmailsList.md)
 ...
 - [FattureInCloud_Ruby_Sdk::IssuedDocumentItemsList](docs/IssuedDocumentItemsList.md)
 - [FattureInCloud_Ruby_Sdk::IssuedDocumentPaymentsList](docs/IssuedDocumentPaymentsList.md)
 ...
 - [FattureInCloud_Ruby_Sdk::IssuedDocumentRefersTo](docs/IssuedDocumentRefersTo.md)
 ...
 - [FattureInCloud_Ruby_Sdk::ListF24ResponseAggregatedDataAggregatedData](docs/ListF24ResponseAggregatedDataAggregatedData.md)
 ...
 - [FattureInCloud_Ruby_Sdk::ReceivedDocumentItemsList](docs/ReceivedDocumentItemsList.md)
 - [FattureInCloud_Ruby_Sdk::ReceivedDocumentPaymentTerms](docs/ReceivedDocumentPaymentTerms.md)
 - [FattureInCloud_Ruby_Sdk::ReceivedDocumentPaymentsList](docs/ReceivedDocumentPaymentsList.md)
 ...
 - [FattureInCloud_Ruby_Sdk::UploadIssuedDocumentAttachmentResponseData](docs/UploadIssuedDocumentAttachmentResponseData.md)
 - [FattureInCloud_Ruby_Sdk::UploadReceivedDocumentAttachmentResponse](docs/UploadReceivedDocumentAttachmentResponse.md)
 - [FattureInCloud_Ruby_Sdk::UploadReceivedDocumentAttachmentResponseData](docs/UploadReceivedDocumentAttachmentResponseData.md)
