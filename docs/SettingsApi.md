...
opts = {
  create_payment_account_request: FattureInCloudSdk::CreatePaymentAccountRequest.new # CreatePaymentAccountRequest | 
}
...
company_id = 12345 # Integer | The ID of the company.
opts = {
  create_payment_method_request: FattureInCloudSdk::CreatePaymentMethodRequest.new # CreatePaymentMethodRequest | 
}
...
company_id = 12345 # Integer | The ID of the company.
opts = {
  create_vat_type_request: FattureInCloudSdk::CreateVatTypeRequest.new # CreateVatTypeRequest | 
}
...
payment_account_id = 56 # Integer | The Referred Payment Account Id.
opts = {
  modify_payment_account_request: FattureInCloudSdk::ModifyPaymentAccountRequest.new # ModifyPaymentAccountRequest | 
}
...
payment_method_id = 56 # Integer | The Referred Payment Method Id.
opts = {
  modify_payment_method_request: FattureInCloudSdk::ModifyPaymentMethodRequest.new # ModifyPaymentMethodRequest | 
}
...
vat_type_id = 56 # Integer | The Referred Vat Type Id.
opts = {
  modify_vat_type_request: FattureInCloudSdk::ModifyVatTypeRequest.new # ModifyVatTypeRequest | 
}
