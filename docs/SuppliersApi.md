...
api_instance = module_name::SuppliersApi.new
company_id = 12345 # Integer | The ID of the company.
opts = {
  create_supplier_request: module_name::CreateSupplierRequest.new # CreateSupplierRequest | The supplier to create
}
...
supplier_id = 56 # Integer | The ID of the supplier.
opts = {
  modify_supplier_request: module_name::ModifySupplierRequest.new # ModifySupplierRequest | The modified Supplier. First level parameters are managed in delta mode.
}
