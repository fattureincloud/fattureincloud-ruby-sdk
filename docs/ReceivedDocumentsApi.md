# FattureInCloud::Ruby::Sdk::ReceivedDocumentsApi
...
api_instance = FattureInCloud::Ruby::Sdk::ReceivedDocumentsApi.new
company_id = 12345 # Integer | The ID of the company.
opts = {
  create_received_document_request: FattureInCloud::Ruby::Sdk::CreateReceivedDocumentRequest.new({data: FattureInCloud::Ruby::Sdk::ReceivedDocument.new({entity: FattureInCloud::Ruby::Sdk::ReceivedDocumentEntity.new})}) # CreateReceivedDocumentRequest | Document to create
}
...
document_id = 56 # Integer | The ID of the document.
opts = {
  get_existing_received_document_totals_request: FattureInCloud::Ruby::Sdk::GetExistingReceivedDocumentTotalsRequest.new # GetExistingReceivedDocumentTotalsRequest | Received document.
}
...
company_id = 12345 # Integer | The ID of the company.
opts = {
  get_new_received_document_totals_request: FattureInCloud::Ruby::Sdk::GetNewReceivedDocumentTotalsRequest.new # GetNewReceivedDocumentTotalsRequest | Received document.
}
...
document_id = 56 # Integer | The ID of the document.
opts = {
  modify_received_document_request: FattureInCloud::Ruby::Sdk::ModifyReceivedDocumentRequest.new # ModifyReceivedDocumentRequest | Modified document.
}
