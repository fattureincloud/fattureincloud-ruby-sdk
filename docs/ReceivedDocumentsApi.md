...
api_instance = FattureInCloudSdk::ReceivedDocumentsApi.new
company_id = 12345 # Integer | The ID of the company.
opts = {
  create_received_document_request: FattureInCloudSdk::CreateReceivedDocumentRequest.new({data: FattureInCloudSdk::ReceivedDocument.new({entity: FattureInCloudSdk::ReceivedDocumentEntity.new})}) # CreateReceivedDocumentRequest | Document to create
}
...
document_id = 56 # Integer | The ID of the document.
opts = {
  get_existing_received_document_totals_request: FattureInCloudSdk::GetExistingReceivedDocumentTotalsRequest.new # GetExistingReceivedDocumentTotalsRequest | Received document.
}
...
company_id = 12345 # Integer | The ID of the company.
opts = {
  get_new_received_document_totals_request: FattureInCloudSdk::GetNewReceivedDocumentTotalsRequest.new # GetNewReceivedDocumentTotalsRequest | Received document.
}
...
document_id = 56 # Integer | The ID of the document.
opts = {
  modify_received_document_request: FattureInCloudSdk::ModifyReceivedDocumentRequest.new # ModifyReceivedDocumentRequest | Modified document.
}
