# module_name::ReceivedDocumentsApi
...
api_instance = module_name::ReceivedDocumentsApi.new
company_id = 12345 # Integer | The ID of the company.
opts = {
  create_received_document_request: module_name::CreateReceivedDocumentRequest.new({data: module_name::ReceivedDocument.new({entity: module_name::ReceivedDocumentEntity.new})}) # CreateReceivedDocumentRequest | Document to create
}
...
document_id = 56 # Integer | The ID of the document.
opts = {
  get_existing_received_document_totals_request: module_name::GetExistingReceivedDocumentTotalsRequest.new # GetExistingReceivedDocumentTotalsRequest | Received document.
}
...
company_id = 12345 # Integer | The ID of the company.
opts = {
  get_new_received_document_totals_request: module_name::GetNewReceivedDocumentTotalsRequest.new # GetNewReceivedDocumentTotalsRequest | Received document.
}
...
document_id = 56 # Integer | The ID of the document.
opts = {
  modify_received_document_request: module_name::ModifyReceivedDocumentRequest.new # ModifyReceivedDocumentRequest | Modified document.
}
