...
api_instance = module_name::ProductsApi.new
company_id = 12345 # Integer | The ID of the company.
opts = {
  create_product_request: module_name::CreateProductRequest.new # CreateProductRequest | 
}
...
product_id = 56 # Integer | The ID of the product.
opts = {
  modify_product_request: module_name::ModifyProductRequest.new # ModifyProductRequest | Modified product details.
}
