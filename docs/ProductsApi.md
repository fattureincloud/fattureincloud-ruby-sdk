# FattureInCloud::Ruby::Sdk::ProductsApi
...
api_instance = FattureInCloud::Ruby::Sdk::ProductsApi.new
company_id = 12345 # Integer | The ID of the company.
opts = {
  create_product_request: FattureInCloud::Ruby::Sdk::CreateProductRequest.new # CreateProductRequest | 
}
...
product_id = 56 # Integer | The ID of the product.
opts = {
  modify_product_request: FattureInCloud::Ruby::Sdk::ModifyProductRequest.new # ModifyProductRequest | Modified product details.
}
