...
api_instance = FattureInCloudSdk::CashbookApi.new
company_id = 12345 # Integer | The ID of the company.
opts = {
  create_cashbook_entry_request: FattureInCloudSdk::CreateCashbookEntryRequest.new # CreateCashbookEntryRequest | Cashbook entry. 
}
...
document_id = 56 # Integer | The ID of the document.
opts = {
  modify_cashbook_entry_request: FattureInCloudSdk::ModifyCashbookEntryRequest.new # ModifyCashbookEntryRequest | Cashbook Entry
}
