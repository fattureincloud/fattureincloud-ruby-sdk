# FattureInCloud::Ruby::Sdk::ReceiptsApi
...
api_instance = FattureInCloud::Ruby::Sdk::ReceiptsApi.new
company_id = 12345 # Integer | The ID of the company.
opts = {
  create_receipt_request: FattureInCloud::Ruby::Sdk::CreateReceiptRequest.new # CreateReceiptRequest | The Receipt to create.
}
...
document_id = 56 # Integer | The ID of the document.
opts = {
  modify_receipt_request: FattureInCloud::Ruby::Sdk::ModifyReceiptRequest.new # ModifyReceiptRequest | Modified receipt.
}
