...
api_instance = module_name::ReceiptsApi.new
company_id = 12345 # Integer | The ID of the company.
opts = {
  create_receipt_request: module_name::CreateReceiptRequest.new # CreateReceiptRequest | The Receipt to create.
}
...
document_id = 56 # Integer | The ID of the document.
opts = {
  modify_receipt_request: module_name::ModifyReceiptRequest.new # ModifyReceiptRequest | Modified receipt.
}
