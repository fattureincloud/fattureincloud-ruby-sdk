# module_name::IssuedDocumentsApi
...
api_instance = module_name::IssuedDocumentsApi.new
company_id = 12345 # Integer | The ID of the company.
opts = {
  create_issued_document_request: module_name::CreateIssuedDocumentRequest.new # CreateIssuedDocumentRequest | The Issued Document
}
...
document_id = 56 # Integer | The ID of the document.
opts = {
  get_existing_issued_document_totals_request: module_name::GetExistingIssuedDocumentTotalsRequest.new # GetExistingIssuedDocumentTotalsRequest | 
}
...
company_id = 12345 # Integer | The ID of the company.
opts = {
  get_new_issued_document_totals_request: module_name::GetNewIssuedDocumentTotalsRequest.new # GetNewIssuedDocumentTotalsRequest | 
}
...
document_id = 56 # Integer | The ID of the document.
opts = {
  modify_issued_document_request: module_name::ModifyIssuedDocumentRequest.new # ModifyIssuedDocumentRequest | The modified document
}
...
document_id = 56 # Integer | The ID of the document.
opts = {
  schedule_email_request: module_name::ScheduleEmailRequest.new # ScheduleEmailRequest | Email Schedule
}
