...
document_id = 56 # Integer | The ID of the document.
opts = {
  modify_archive_document_request: module_name::ModifyArchiveDocumentRequest.new # ModifyArchiveDocumentRequest | Modified Archive Document
}
