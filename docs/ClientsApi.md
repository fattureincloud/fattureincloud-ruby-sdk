# FattureInCloud::Ruby::Sdk::ClientsApi
...
api_instance = FattureInCloud::Ruby::Sdk::ClientsApi.new
company_id = 12345 # Integer | The ID of the company.
opts = {
  create_client_request: FattureInCloud::Ruby::Sdk::CreateClientRequest.new # CreateClientRequest | The client to create
}
...
client_id = 56 # Integer | The ID of the client.
opts = {
  modify_client_request: FattureInCloud::Ruby::Sdk::ModifyClientRequest.new # ModifyClientRequest | The modified Client. First level parameters are managed in delta mode.
}
