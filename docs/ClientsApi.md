...
api_instance = FattureInCloudSdk::ClientsApi.new
company_id = 12345 # Integer | The ID of the company.
opts = {
  create_client_request: FattureInCloudSdk::CreateClientRequest.new # CreateClientRequest | The client to create
}
...
client_id = 56 # Integer | The ID of the client.
opts = {
  modify_client_request: FattureInCloudSdk::ModifyClientRequest.new # ModifyClientRequest | The modified Client. First level parameters are managed in delta mode.
}
