...
api_instance = module_name::TaxesApi.new
company_id = 12345 # Integer | The ID of the company.
opts = {
  create_f24_request: module_name::CreateF24Request.new # CreateF24Request | The F24 to create
}
...
document_id = 56 # Integer | The ID of the document.
opts = {
  modify_f24_request: module_name::ModifyF24Request.new # ModifyF24Request | The F24
}
